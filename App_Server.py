...
def attendance_mark(self: SH, *args, **kwargs):
	...
	students_attendance_rate = {student_id: round(students_attendance_overall[student_id]*100 / total_classes, 2) for student_id in students_attendance_overall}
...
def emergency(self: SH, *args, **kwargs):
	"""
	Everyone can see the emergency contact number
